...
export default function LandingPage() {
  ...
  return (
    <main className="min-h-screen flex flex-col items-center justify-center p-4 relative overflow-hidden bg-[oklch(0.1_0.02_260)]">
      ...
      <nav className="fixed top-6 right-20 z-[100] hidden md:flex items-center gap-6">
        ...
        <button onClick={() => router.push('/admin')} className="text-sm font-bold uppercase tracking-widest text-white/40 hover:text-primary transition-colors">
          Admin
        </button>
      </nav>
