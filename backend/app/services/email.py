...
def send_report_email(
    ...
    # Localized email text
    email_texts = {
        "lt": {
            "greeting": "Sveiki",
            "intro": "Ačiū, kad naudojotės mūsų pirties projektavimo paslauga. Žemiau rasite pilną jūsų projekto ataskaitą.",
            "footer1": "Ši ataskaita buvo automatiškai sugeneruota Pirtis Voice Agent sistemos.",
            "footer2": "Jei turite klausimų, susisiekite su mumis.",
        },
        "en": {
            "greeting": "Hello",
            "intro": "Thank you for using our sauna design service. Below you will find your complete project report.",
            "footer1": "This report was automatically generated by the Pirtis Voice Agent system.",
            "footer2": "If you have any questions, please contact us.",
        },
        "ru": {
            "greeting": "Здравствуйте",
            "intro": "Благодарим вас за использование нашего сервиса проектирования саун. Ниже вы найдёте полный отчёт о вашем проекте.",
            "footer1": "Этот отчёт был автоматически сгенерирован системой Pirtis Voice Agent.",
            "footer2": "Если у вас есть вопросы, свяжитесь с нами.",
        },
    }
...
"""
    ...
    filenames = {
        "lt": f"pirties-ataskaita-{session_id[:8]}.md",
        "en": f"sauna-report-{session_id[:8]}.md",
        "ru": f"otchet-sauna-{session_id[:8]}.md",
    }
    filename = filenames.get(language, filenames["lt"])
